...
\begin{itemize}
    ...
    \texttt{cancelada} y las futuras \texttt{pendiente}, \texttt{cancelada} o \texttt{confirmada}.
...
6 & Clientes con dos o más reservas completadas y su consumo acumulado & 1, 3, 11 & Juntas externas, \texttt{GROUP BY}, \texttt{HAVING} \\
